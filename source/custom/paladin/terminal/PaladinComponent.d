...
class PaladinComponent : AbstractComponent {
    ...
    override void draw() {
      ...
      terminal.puts(0, terminal.width()*2/3, format("World tick: %d", world.count));
      terminal.puts(1, terminal.width()*2/3, format("Your stamina: %d/%d", hero.stamina, hero.maxStamina));
